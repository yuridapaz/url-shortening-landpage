    ...
    <FooterDiv>
      <div className='footer-section'>
        <div className='title-section'>
          <svg className='title-logo' xmlns='http://www.w3.org/2000/svg' width='121' height='33'>
            <path
              fill='#fff'
        ...
        <div className='links-section'>
          <div className='links-subsection'>
            <h2 className='naming'>Features</h2>
          ...
          <div className='links-subsection'>
            <h2 className='naming'>Resources</h2>
            <ul className='links-list'>
              <li>
                <a href='/' className='link-anchor'>
                  Blog
          ...
          <div className='links-subsection'>
            <h2 className='naming'>Company</h2>
            <ul className='links-list'>
              <li>
                <a href='/' className='link-anchor'>
                  About
